...
button8 = Button(frame, text=8, height=3, width=6, font=35,command=lambda: button_press(8))
...
multiply = Button(frame, text='*', height=3, width=6, font=35,command=lambda: button_press('*'))
...
clear = Button(window, text='clear', height=3, width=12, font=35,bg="grey",command=clear)
clear.pack()
